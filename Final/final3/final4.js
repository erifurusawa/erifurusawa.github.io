...
function loadData(){      // this function needs to be under setup()
	...
	// sort bldgs object //////////////////////////////////////////////
	// bldgs_sorted = sortProperties(bldgs, 4); 
...
function draw(){
	...
	// console.log(bldgs_sorted[4530]);
	// console.log(bldgs_sorted[100]);
	// background(255);
	// // margin(20);
	...
	// 	var area_original = bldgs[[i]][7];
	// 	var area = map(area_original, 0, 30000, 0, 10);
	// 	var zone_rownum = 17;
	// 	var nozone_rownum = 50;
	// 	var zone = bldgs[[i]][8];
	// 	var firstx = bldgs[[i]][2];
	// 	var firsty = bldgs[[i]][3];
	// 	var year = bldgs[[i]][5];
	...
	// 	// console.log(bldgs[outlines[i]][0][0][3]);
	// 	beginShape();
		
	// 	for (var j = 0; j < bldgs[[i]][0][0].length; j++){
	// 		// console.log(bldgs[outlines[i]].length);
	// 		// var point_x = map(outlines[i][0][j][0], 980000, 1000000, 0, 1000);
	// 		var point_x = map(bldgs[[i]][0][0][j][0], 980000, 1000000, 0, 1000);
	// 		var point_y = map(bldgs[[i]][0][0][j][1], 190000, 210000, 0, 1000);
