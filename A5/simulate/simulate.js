...
function setup() {
  ...
  createP("Boids slow down every hour, and become more aligned every minute")
...
function Boid(x,y) {
  ...
  // var h = 0;
  // var h = 24;
  var speed_hour = map(1/(h + 1), 0, 1, 0, 30);
...
// Alignment (tendency to move in the same direction)
...
// Cohesion (tendency to form a cluster)
